...
public class ProductServiceImpl implements ProductService {
	...
	public ResponseEntity<Object> findAll() {
		Map<String, Object> responseCommon = ResponseHandler.ResponseCommon(200, "Product find all success", productRepository.findBy());
	...
	public ResponseEntity<Object> updateProduct(Long id, UpdateProductDto dto) {
		...
		productRepository.save(opProduct.get());
		Map<String, Object> responseCommon = ResponseHandler.ResponseCommon(200, "Product update success", true);
		return ResponseEntity.status(HttpStatus.OK).body(responseCommon);
