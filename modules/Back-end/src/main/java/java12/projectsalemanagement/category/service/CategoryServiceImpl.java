...
public class CategoryServiceImpl implements CategoryService {
	...
	public ResponseEntity<Object> findAll() {
		Map<String, Object> responseCommon = ResponseHandler.ResponseCommon(200, "Category find success",
	...
	public ResponseEntity<Object> findById(long id) {
		Optional<CategoryDto> opCategory = categoryRepository.findCategoryById(id);
		if (!opCategory.isPresent()) {
			Map<String, Object> responseCommon = ResponseHandler.ResponseCommon(404, "Category is not exist", false);
			return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(responseCommon);
		}
